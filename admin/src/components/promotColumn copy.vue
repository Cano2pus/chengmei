...
export default {
  ...
  methods: {
    ...
    confirm() {
      ...
      this.request(data, "/api/admin/promotionTypeAddModify");
    },
    ban(val) {
      let data = {
        token: this.$store.getters.getToken,
      ...
      this.request(data, "/api/admin/promotionTypeBan");
    },
    selectionChange(val) {
    ...
    deleteAll() {
      this.multipleSelection.forEach(element => {
        ...
        this.request(data, "/api/admin/promotionTypeDelete");
      });
    },
    dele(val) {
      let data = {
