...
export default {
  ...
  methods: {
    getList(_page, _size) {
      axios({
        method: "POST",
        url: this.$store.getters.getDomain + "api/admin/bannerList",
        data: {
    ...
    confirm() {
      ...
      this.request(data, "/api/admin/bannerAddModify");
    },
    ban(val) {
      let data = {
        token: this.$store.getters.getToken,
      ...
      this.request(data, "/api/admin/bannerBan");
    },
    selectionChange(val) {
    ...
    deleteAll() {
      this.multipleSelection.forEach(element => {
        let data = {
          token: this.$store.getters.getToken,
          id: element.banner_id
        };
        this.request(data, "/api/admin/bannerDelete");
      });
    },
    dele(val) {
      let data = {
